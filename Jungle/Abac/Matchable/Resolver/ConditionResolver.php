...
namespace Jungle\ABAC\Matchable\Resolver {
	...
	use Jungle\ABAC\Context\Substitute;
	use Jungle\ABAC\Context\SubstituteInterface;
	use Jungle\ABAC\Matchable\Resolver;
	use Jungle\ABAC\Matchable\Resolver\ConditionResolver\ABACException as ResolveException;
	use Jungle\ABAC\Matchable\Resolver\ConditionResolver\Exception\BadMethodCall;
	use Jungle\ABAC\Matchable\Resolver\ConditionResolver\Exception\InvalidQuery;
	use Jungle\ABAC\Matchable\Resolver\ConditionResolver\Exception\PathNotFound;
	...
	class ConditionResolver extends Resolver{
		...
		/** @var  \Jungle\ABAC\Context\Context */
