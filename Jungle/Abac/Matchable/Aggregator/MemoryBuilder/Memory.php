 ...
 * Time: 2:29
 */
namespace Jungle\ABAC\Matchable\Aggregator\MemoryBuilder {

	use Jungle\ABAC\Matchable\Aggregator;
	use Jungle\ABAC\Matchable\Aggregator\Policy;
	use Jungle\ABAC\Matchable\Aggregator\PolicyGroup;
	use Jungle\ABAC\Matchable\Matchable;
	use Jungle\ABAC\Matchable\Rule;
	use Jungle\ABAC\Matchable\Target;

	/**
	 * Class Memory
	 * @package Jungle\Abac\Adapter\PolicyAdater
	 */
